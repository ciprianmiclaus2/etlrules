...
To install Finrules, run this command in your terminal:
...
The sources for Finrules can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/ciprianmiclaus/finrules
.. _tarball: https://github.com/ciprianmiclaus/finrules/tarball/master
