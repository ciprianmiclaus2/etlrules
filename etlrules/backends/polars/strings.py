...
class StrLowerRule(BaseAssignColumnRule, PolarsMixin):
...
class StrUpperRule(BaseAssignColumnRule, PolarsMixin):
...
class StrCapitalizeRule(BaseAssignColumnRule, PolarsMixin):
...
class StrSplitRule(BaseAssignColumnRule, PolarsMixin):
...
class StrSplitRejoinRule(BaseAssignColumnRule, PolarsMixin):
...
class StrStripRule(BaseAssignColumnRule, PolarsMixin):
...
class StrPadRule(BaseAssignColumnRule, PolarsMixin):
...
class StrExtractRule(UnaryOpBaseRule, ColumnsInOutMixin, PolarsMixin):
